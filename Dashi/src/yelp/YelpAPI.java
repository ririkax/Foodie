...
public class YelpAPI {
    ...
    private static final String CONSUMER_KEY = "O_nn1y8K_AxuLyq6hH2etg";
    private static final String CONSUMER_SECRET = "Lc0MmjCepdgkbIj6fuD3E06PKoA";
    private static final String TOKEN = "RKSHmJwxbgoTw2lUUdUuJ9FLLltUN9wK";
    private static final String TOKEN_SECRET = "FJf-DI9CZrvWO40jVa31LeNNELo";
